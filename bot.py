...
motivation = [
"Чем усерднее вы работаете, тем более удачливым вы становитесь",
...
career = [
"Ты не можешь дефилировать до конца своей жизни, поэтому очень важно то, как ты разнообразишь свою карьеру.",
...
"Самое большое достижение человека в его профессиональной области – ситуация, когда он считает себя лучшим в мире.",
...
def time(message):
    ...
    bot.send_message(message.chat.id, "Сегодня, за окном " + date + " и время сейчас " + int(time)+3)
